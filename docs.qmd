...
![Table 1: Summary of First 15 rows of Heart Transplant Dataset](Table1 Head data set.png)
...
![Table 2: Excluding Wait Time](Table 2 Excluding wait time.png)
...
![Table 3: Including Wait Time for Transplant Recipients](Table_3_Including_wait_time.png)
...
![Table 4: Without Accepted Year](Table 4 Without accepted year.png)
...
![Table 5: ANOVA Table](Table 5 ANOVA table.png)
...
![Table 6: Proportional Hazard p-values](Table 6 Proportional Hazard.png){width="602"}
...
![Table 7: Stratified Transplant Status](Table 7 Stratified Transplant.png){width="894"}
...
::: incremental
-   Second histogram created to condense age ranges for better insight
...
![Image 4: Survival Plot Heart Transplant vs No Heart Transplant](Image 4 Survival Plot.png) .
